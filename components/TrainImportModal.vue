<template>
    <div class="modal fade" id="trainImportModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Import Data Latih</h5>
        ...
        async importExcel() {
            try {
                ...
                if (file) {
                    ...
                    const res = await fetchAPI('/data/train/import', {
                        method: 'POST',
                        body: {
                            empty: this.empty,
                            file: file_base64
